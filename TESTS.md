...
Perl 5.18.4, 5.24.4, 5.36.3, and 5.44.0 each passed the embedded-prefix/core
smoke, static Socket smoke, and all eight asynchronous disposal probes. The
build also ran 17 SFS generator checks and the native SFS runtime suite for
