...
sub run {
    ...
    # Required WebDyne surface supplied by the deliberately small WASI POSIX
    # facade. The complete platform-specific POSIX module is not emulated.
    eval {
        require POSIX;
